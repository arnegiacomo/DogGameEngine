...
public class Blueflowers extends StaticEntity{
	
	public static int frequency = 3;

	public Blueflowers(float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.blueflowers, (int) (x - Game.instance.gameCamera.getxOffset()), 
